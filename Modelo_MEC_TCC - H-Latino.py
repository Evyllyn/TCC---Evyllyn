...
for i in range(MONTE_CARLO_REP):
    dados_material_instancia = DadosMaterial(caminho_arquivo="Viga_1_8.txt", force_node=monte_carlo_F[i], modulo_elasticy=monte_carlo_E[i])
    ...
    if evento_falhou(g1):
        ...
        solicitacao_com_falha.append(g1)  # Solicitação no evento de falha
